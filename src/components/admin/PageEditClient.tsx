...
const PAGE_SECTION_TYPES: Record<string, SectionType[]> = {
  home: ["hero", "intro", "globalStandards"],
  services: ["servicesLicensing"],
  about: ["aboutHero", "aboutMission", "aboutLeadership", "aboutRegulatory", "aboutCTA"],
  ...
  switch (type) {
    ...
    case "aboutMission":
      return {
        ...
        description:
          "Cryptonexis Limited bridges the gap between traditional finance and decentralized innovation.",
        pillars: [
          { title: "CORE PHILOSOPHY", description: "Precision over hype." },
          { title: "TARGET HORIZON", description: "Securing generational wealth through advanced custody protocols." },
        ],
      };
        ...
        members: [
          {
            ...
            bio: "Former Lead Architect at Swiss Global Assets.",
    ...
    case "aboutRegulatory":
      return {
        ...
        description: "Cryptonexis Limited operates under strict oversight within the UAE's digital economy.",
        stats: [
        ...
        cardItems: ["Periodic independent security and financial audits."],
      };
