...
const AboutOverviewSection = ({ content }: { content: AboutOverviewContent }) => {
  const [primaryStat, secondaryStat] = content.stats;
  const [primaryImageRaw, secondaryImageRaw] = content.images;
  const primaryImage = primaryImageRaw || "/home/hero-bg.jpg";
  const secondaryImage = secondaryImageRaw || "/home/headquarters.png";
